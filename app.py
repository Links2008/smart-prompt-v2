#!/usr/bin/env python3
"""
QQ音乐→Apple Music歌单迁移工具 - 完全复刻GoMusic架构
"""
import sys
...
app = FastAPI(title="QQ音乐→Apple Music歌单迁移工具", version="2.0.0")
...
async def root():
    ...
    return {"message": "QQ音乐→Apple Music歌单迁移工具", "version": "2.0.0", "docs": "/docs"}
...
<body>
    <div class="container">
        ...
        <div class="card">
            ...
            <div id="exportContainer" style="display: none; margin-top: 20px;">
                <h3 style="margin-bottom: 15px;">导出格式</h3>
                <div class="export-options">
                    <button class="export-btn" onclick="exportSongs('text')">📝 TuneMyMusic格式</button>
                    <button class="export-btn" onclick="exportSongs('csv')">📊 CSV格式</button>
                </div>
                <div id="exportResultContainer" style="margin-top: 15px; display: none;">
            ...
            <div class="tips">
                <h3>💡 使用说明</h3>
                <p>
                    1. 在QQ音乐App或网页版中，打开歌单 → 点击分享 → 复制链接
                    <br>
                    2. 将链接粘贴到输入框，点击获取歌单
                    <br>
                    3. 确认歌单内容无误后，选择导出格式
                    <br>
                    4. 将导出的内容复制到
                    <a href="https://www.tunemymusic.com" target="_blank">TuneMyMusic</a>
                    或其他工具进行导入
                    <br><br>
                    相关工具:<br>
                    - TuneMyMusic: https://www.tunemymusic.com<br>
    ...
    <script>
        ...
        function clearStatus() { document.getElementById('statusContainer').innerHTML = ''; }
        ...
        async function exportSongs(format) {
            try {
                ...
                document.getElementById('exportResultContainer').style.display = 'block';
